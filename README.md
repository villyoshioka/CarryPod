...
[![Version](https://img.shields.io/badge/Version-2.3.0-green.svg)](https://github.com/villyoshioka/CarryPod/releases)
...
4. 進捗を確認しながら完了を待ちます（時間がかかる場合がありますので、その間に麦茶でもどうぞ）
